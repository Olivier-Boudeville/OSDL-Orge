...
% Records information about fatigue.
-record( creature_fatigue_model, {

	% Physical fatigue:
	max_physical_fatigue :: physical_fatigue/0,
	physical_fatigue_recovery_rate :: physical_fatigue_recovery_rate(),

	% Mental fatigue:
	max_mental_fatigue :: mental_fatigue(),
	mental_fatigue_recovery_rate :: mental_fatigue_recovery_rate()} ).
...
-record( creature_state_attributes, {
	...
	physical_fatigue :: class_Createphysical_fatigue(),
	mental_fatigue,
