...
_____________________________________
 ...
 - base probability of success: 75%
 - probability of success modifiers:
 
   - relative to the spellcasting method:
   
     - with Incantations: +0%
	 - with Gesture SpellCasting: +0%
	 - with Rune Carving: +0%
	 - with Bardic Verse: +0%
	 - with Pure Mental SpellCasting: -70%
   ...
   - relative to the spell caster:
     ...
     - characteristics: 
	   ...
	   - +5% of probability of success per level of Arcane skill
	   - +5% of probability of success per level of arcane technics for the spellcasting method being used
