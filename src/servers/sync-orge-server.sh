...
echo "NOTE: script probably obsolete, using Git instead."

usage="Usage: $(basename $0): synchronises all Ceylan and OSDL code for an Orge server from a remote reference host."
